...
class Block:
    ...
    Store transactions in a blockchain that supports a cyptocurrency.
    """
    ...
    def mine_block(last_block, data):
        ...
        return Block(timestamp, last_block, hash, data, difficulty, nonce)
    ...
    def is_valid_block(last_block, block):
        ...
        - The hash must be valid combo of the block fields
        - The proof of work should be valid
...
def main():
    ...
    #program doesn't crash, there is no stack trace shown
    try:
